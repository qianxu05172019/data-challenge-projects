...
training_examples = preprocess_features(california_housing_dataframe.head(750000))
training_targets = preprocess_targets(california_housing_dataframe.head(750000))
...
'''
 ...
 def construct_feature_columns():
  ...
  transfomed_label = encoder.fit_transform(training_examples["companyId"])
  '''
  '''
...
display.display(feature_columns.describe())
'''
_ = train_model(
    learning_rate=1.0,
    steps=500,
